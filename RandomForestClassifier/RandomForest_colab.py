...
def SVM_classifier():
    ...
    def compute_Random_forest(X_train, y_train):
        clf = ExtraTreesClassifier(n_estimators=1000, min_samples_split=10, min_samples_leaf=1,
    ...
    # Data splitting
    X_train, X_test, y_train, y_test = train_test_split(X_std_scaled, y, test_size=0.3)  # when using .csv file
